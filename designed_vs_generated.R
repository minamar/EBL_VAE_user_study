...
anth_all$condition = factor(anth_all$condition, levels = c("designed_pre", "generated_pre", "designed_post", "generated_post"))
...
anim_all$condition = factor(anim_all$condition, levels = c("designed_pre", "generated_pre", "designed_post", "generated_post"))
